...
for compi = 1:size(comparisons,1)
    ...
    % Save the output
    saveName = [comparisons{compi,1},'_',comparisons{compi,2},'_',comparisons{compi,3},'_',comparisons{compi,4}];
...
for compi = 1:size(comparisons,1)
    ...
    % Load the results
    loadName = [comparisons{compi,1},'_',comparisons{compi,2},'_',comparisons{compi,3},'_',comparisons{compi,4}];
