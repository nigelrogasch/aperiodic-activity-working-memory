...
for compi = 1:size(comparisons,1)
    ...
    % Save the output
    saveName = ['correlation_capacity_kcd_',comparisons{compi,1},'_',comparisons{compi,2}];
...
for compi = 1:size(comparisons,1)
    ...
    % Load the results
    loadName = ['correlation_capacity_kcd_',comparisons{compi,1},'_',comparisons{compi,2}];
