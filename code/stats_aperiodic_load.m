% Run a permutation test comparing the effects of load on aperiodic activity.
%
...
comparisons = {'slope','L04Abschange','L02Abschange';...
    'slope','L06Abschange','L02Abschange';...
    'slope','L06Abschange','L04Abschange';...
    'offset','L04Abschange','L02Abschange';...
    'offset','L06Abschange','L02Abschange';...
    'offset','L06Abschange','L04Abschange'};
...
for compi = 1:size(comparisons,1)
    ...
    % Save the output
    saveName = [comparisons{compi,1},'_',comparisons{compi,2},'_',comparisons{compi,3}];
...
for compi = 1:size(comparisons,1)
    ...
    % Load the results
    loadName = [comparisons{compi,1},'_',comparisons{compi,2},'_',comparisons{compi,3}];
