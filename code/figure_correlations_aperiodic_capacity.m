...
statFiles = {'correlation_capacity_slope_L02Abschange',...
    'correlation_capacity_slope_L04Abschange',...
    'correlation_capacity_slope_L06Abschange',...
...
print(f,'-dpng',[pathFigures,'figure_correlation_aperiodic_capacity']);
