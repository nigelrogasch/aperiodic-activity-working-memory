% Run a permutation test comparing the effects of load on alpha
% oscillations.
%
...
comparisons = {'L04change','L02change';...
    'L06change','L02change';...
    'L06change','L04change'};
...
for compi = 1:size(comparisons,1)
    ...
    % Save the output
    saveName = ['alpha_',comparisons{compi,1},'_',comparisons{compi,2}];
...
for compi = 1:size(comparisons,1)
    ...
    % Load the results
    loadName = ['alpha_',comparisons{compi,1},'_',comparisons{compi,2}];
